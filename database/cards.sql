...
insert into attacks values (2, "Headbutt Bounce", "", null)
...
insert into attacks values (3, "Swift", "This attack's damage isn't affected by Weakness or Resistance, or by any effects on your opponent's Active Pokémon.", null)
...
insert into attacks values (4, "Collect", "Draw a card.", null)
insert into "cost" values (13, "Colorless", 0, 4, "attack"); 
insert into attacks values (5, "Leaf Step", "", null)
...
insert into attacks values (6, "Bind Down", "During your opponent's next turn, the Defending Pokémon can't retreat.", null)
...
insert into attacks values (7, "Miasma Wind", "This attack does 100 damage for each Special Condition affecting your opponent's Active Pokémon.", null)
...
insert into attacks values (8, "Nosh", "Heal 40 damage from this Pokémon.", null)
insert into "cost" values (23, "Colorless", 0, 8, "attack"); 
insert into attacks values (9, "Loom Over", "This attack does 10 less damage for each damage counter on this Pokémon.", null)
...
insert into attacks values (10, "Reaping Dash", "Before doing damage, discard all Pokémon Tools and Special Energy from your opponent's Active Pokémon.", null)
...
insert into attacks values (11, "Ambush", "Flip a coin. If heads, this attack does 30 more damage.", null)
...
insert into attacks values (12, "Double Spin", "Flip 2 coins. This attack does 10 damage for each heads.", null)
...
insert into attacks values (13, "Breezy Gift", "Put this Pokémon and all attached cards into your deck. If you do, search your deck for up to 3 cards and put them into your hand. Then, shuffle your deck.", null)
insert into "cost" values (37, "Colorless", 0, 13, "attack"); 
insert into attacks values (14, "Leafage", "", null)
...
insert into attacks values (15, "Spray Fluid", "", null)
...
insert into attacks values (16, "Coated Attack", "During your opponent's next turn, prevent all damage done to this Pokémon by attacks from Basic Pokémon.", null)
...
insert into attacks values (17, "Syrup Storm", "This attack does 30 more damage for each Grass Energy attached to all of your Pokémon.", null)
...
insert into attacks values (18, "Tackle", "", null)
...
insert into attacks values (19, "Spiral Kick", "", null)
...
insert into attacks values (20, "Ram", "", null)
insert into "cost" values (55, "Grass", 0, 20, "attack"); 
insert into attacks values (21, "Gentle Slap", "", null)
...
insert into attacks values (22, "Mega Drain", "Heal 30 damage from this Pokémon.", null)
insert into "cost" values (59, "Grass", 0, 22, "attack"); 
insert into "cost" values (60, "Colorless", 1, 22, "attack"); 
insert into attacks values (23, "Whip Smash", "", null)
...
insert into attacks values (24, "Flop", "", null)
...
insert into attacks values (25, "Burning Run", "Flip a coin. If heads, this attack does 60 more damage.", null)
...
insert into attacks values (26, "Call for Family", "Search your deck for a Basic Pokémon and put it onto your Bench. Then, shuffle your deck.", null)
insert into "cost" values (72, "Colorless", 0, 26, "attack"); 
insert into attacks values (27, "Searing Flame", "Your opponent's Active Pokémon is now Burned.", null)
...
insert into attacks values (28, "Heat Blast", "", null)
...
insert into attacks values (29, "Ember", "Discard an Energy from this Pokémon.", null)
...
insert into attacks values (30, "Sudden Scorching", "Your opponent discards a card from their hand. If this Pokémon evolved from Salandit during this turn, your opponent discards 2 more cards.", null)
insert into "cost" values (84, "Colorless", 0, 30, "attack"); 
insert into "cost" values (85, "Colorless", 1, 30, "attack"); 
insert into attacks values (31, "Flamethrower", "Discard an Energy from this Pokémon.", null)
...
insert into attacks values (32, "Ring of Fire", "Your opponent's Active Pokémon is now Burned. During your opponent's next turn, that Pokémon can't retreat.", null)
...
insert into attacks values (33, "Inferno Onrush", "This Pokémon also does 60 damage to itself.", null)
...
insert into attacks values (34, "Quick Attack", "Flip a coin. If heads, this attack does 10 more damage.", null)
...
insert into attacks values (35, "Low Sweep", "", null)
insert into "cost" values (102, "Fire", 0, 35, "attack"); 
insert into attacks values (36, "Combustion", "", null)
...
insert into attacks values (37, "Flare Strike", "During your next turn, this Pokémon can't use Flare Strike.", null)
...
insert into attacks values (38, "Garnet Volley", "This attack does 180 damage to 1 of your opponent's Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
...
insert into attacks values (39, "Flare", "", null)
...
insert into attacks values (40, "Twin Cannons", "Discard up to 2 Basic Water Energy cards from your hand. This attack does 140 damage for each card you discarded in this way.", null)
...
insert into attacks values (41, "Water Gun", "", null)
insert into "cost" values (121, "Water", 0, 41, "attack"); 
insert into attacks values (42, "Surf", "", null)
...
insert into attacks values (43, "Power Splash", "This attack does 40 damage for each Energy attached to this Pokémon.", null)
insert into "cost" values (127, "Water", 0, 43, "attack"); 
insert into attacks values (44, "Larimar Rain", "Look at the top 20 cards of your deck and attach any number of Energy cards you find there to your Pokémon in any way you like. Shuffle the other cards back into your deck.", null)
...
insert into attacks values (45, "Rollout", "", null)
...
insert into attacks values (46, "Bubble Beam", "Flip a coin. If heads, your opponent's Active Pokémon is now Paralyzed.", null)
...
insert into attacks values (47, "Sprinkle Water", "", null)
...
insert into attacks values (48, "Return", "You may draw cards until you have 6 cards in your hand.", null)
insert into "cost" values (141, "Colorless", 0, 48, "attack"); 
insert into attacks values (49, "Razor Fin", "", null)
...
insert into attacks values (50, "Splashing Turn", "Switch this Pokémon with 1 of your Benched Pokémon.", null)
...
insert into attacks values (51, "Tidal Wave", "", null)
...
insert into attacks values (52, "Rain Splash", "", null)
...
insert into attacks values (53, "Wave Splash", "", null)
...
insert into attacks values (54, "Shifting Shuriken", "Flip a coin. If heads, this attack does 100 more damage.", null)
...
insert into attacks values (55, "Haymaker", "During your next turn, this Pokémon can't use Haymaker.", null)
...
insert into attacks values (56, "Headbutt", "", null)
...
insert into attacks values (57, "Hard Crunch", "If your opponent's Active Pokémon already has any damage counters on it, this attack does 80 more damage.", null)
...
insert into attacks values (58, "Sonic Edge", "This attack's damage isn't affected by any effects on your opponent's Active Pokémon.", null)
...
insert into attacks values (59, "Magnum Punch", "", null)
...
insert into attacks values (60, "Electroslug", "", null)
insert into "cost" values (194, "Lightning", 0, 60, "attack"); 
insert into attacks values (61, "Unleash Lightning", "During your next turn, your Pokémon can't attack. (This includes new Pokémon that come into play.)", null)
...
insert into attacks values (62, "Double Voltage", "Flip 2 coins. This attack does 20 damage for each heads.", null)
...
insert into attacks values (63, "Disorienting Flash", "Your opponent's Active Pokémon is now Confused. Put 8 damage counters instead of 3 on that Pokémon for this Special Condition.", null)
insert into "cost" values (204, "Colorless", 0, 63, "attack"); 
insert into "cost" values (205, "Colorless", 1, 63, "attack"); 
insert into attacks values (64, "Thunderous Bolt", "During your next turn, this Pokémon can't attack.", null)
...
insert into attacks values (65, "Jolting Charge", "Search your deck for up to 2 Basic Grass Energy cards and up to 2 Basic Lightning Energy cards and attach them to your Pokémon in any way you like. Then, shuffle your deck.", null)
...
insert into attacks values (66, "Charged Web", "If your opponent's Active Pokémon is a Pokémon ex or Pokémon V, this attack does 110 more damage.", null)
insert into "cost" values (213, "Lightning", 0, 66, "attack"); 
insert into "cost" values (214, "Colorless", 1, 66, "attack"); 
insert into attacks values (67, "Fulgurite", "Discard all Energy from this Pokémon. During your opponent's next turn, they can't play any Item cards from their hand.", null)
...
insert into attacks values (68, "Parallel Placement", "Search your deck for up to 3 Charjabug and put them onto your Bench. Then, shuffle your deck.", null)
...
insert into attacks values (69, "Volt Switch", "Switch this Pokémon with 1 of your Benched Lightning Pokémon.", null)
insert into "cost" values (222, "Lightning", 0, 69, "attack"); 
insert into attacks values (70, "Sparking Strike", "", null)
...
insert into attacks values (71, "Electrifying Chance", "If you have exactly 1 Prize card remaining, your opponent's Active Pokémon is now Paralyzed.", null)
...
insert into attacks values (72, "Combat Thunder", "This attack does 20 more damage for each of your opponent's Benched Pokémon.", null)
...
insert into attacks values (73, "Targeted Spark", "This attack does 20 damage to 1 of your opponent's Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
...
insert into attacks values (74, "Dangle Tail", "Put a Pokémon from your discard pile into your hand.", null)
...
insert into attacks values (75, "Seek Inspiration", "Discard the top card of your deck, and if that card is a Pokémon that doesn't have a Rule Box, choose 1 of its attacks and use it as this attack. (Pokémon ex, Pokémon V, etc. have Rule Boxes.)", null)
insert into "cost" values (238, "Psychic", 0, 75, "attack"); 
insert into "cost" values (239, "Colorless", 1, 75, "attack"); 
insert into attacks values (76, "Super Psy Bolt", "", null)
...
insert into attacks values (77, "Expand", "During your opponent's next turn, this Pokémon takes 10 less damage from attacks (after applying Weakness and Resistance).", null)
...
insert into attacks values (78, "Everyone Explode Now", "This attack does 50 damage for each of your Drifloon and Drifblim in play. This attack also does 30 damage to each of your Drifloon and Drifblim. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
...
insert into attacks values (79, "Ominous Eyes", "Put 3 damage counters on 1 of your opponent's Pokémon.", null)
...
insert into attacks values (80, "Flower Shower", "Each player draws 3 cards.", null)
insert into "cost" values (257, "Psychic", 0, 80, "attack"); 
insert into attacks values (81, "Play Rough", "Flip a coin. If heads, this attack does 20 more damage.", null)
...
insert into attacks values (82, "Mumble", "", null)
...
insert into attacks values (83, "Colorful Confection", "Search your deck for up to 5 Pokémon that are the same type as any Basic Energy attached to this Pokémon, reveal them, and put them into your hand. Then, shuffle your deck.", null)
insert into "cost" values (262, "Colorless", 0, 83, "attack"); 
insert into attacks values (84, "Magical Shot", "", null)
...
insert into attacks values (85, "Pleasant Aroma", "Search your deck for a Basic Pokémon and put it onto your Bench. Then, shuffle your deck.", null)
insert into "cost" values (266, "Colorless", 0, 85, "attack"); 
insert into attacks values (86, "Stampede", "", null)
...
insert into attacks values (87, "Wonder Shine", "Your opponent's Active Pokémon is now Confused.", null)
...
insert into attacks values (88, "Peck", "", null)
...
insert into attacks values (89, "Psychic Flash", "", null)
...
insert into attacks values (92, "Adjusted Horn", "If you don't have the same number of cards in your hand as your opponent, this attack does nothing.", null)
...
insert into attacks values (93, "Reckless Charge", "This Pokémon also does 10 damage to itself.", null)
...
insert into attacks values (94, "Growl", "During your opponent's next turn, attacks used by the Defending Pokémon do 40 less damage (before applying Weakness and Resistance).", null)
insert into "cost" values (293, "Fighting", 0, 94, "attack"); 
insert into attacks values (95, "Bone Vengeance", "If any of your Benched Cubone have any damage counters on them, this attack does 120 more damage.", null)
...
insert into attacks values (96, "Horn Attack", "", null)
...
insert into attacks values (97, "Destructive Horn", "Flip a coin. If heads, discard an Energy from your opponent's Active Pokémon.", null)
...
insert into attacks values (98, "Drill Run", "Discard an Energy from your opponent's Active Pokémon.", null)
...
insert into attacks values (99, "Beat", "", null)
...
insert into attacks values (100, "Calm Mind", "Heal 20 damage from this Pokémon.", null)
insert into "cost" values (319, "Colorless", 0, 100, "attack"); 
insert into attacks values (101, "Chop", "", null)
...
insert into attacks values (102, "Double Smash", "Flip 2 coins. This attack does 40 damage for each heads.", null)
...
insert into attacks values (103, "Chi-Atsu", "Put damage counters on your opponent's Active Pokémon until its remaining HP is 50.", null)
insert into "cost" values (326, "Colorless", 0, 103, "attack"); 
insert into "cost" values (327, "Colorless", 1, 103, "attack"); 
insert into attacks values (104, "Yoga Kick", "This attack's damage isn't affected by Weakness or Resistance.", null)
...
insert into attacks values (105, "Punch", "", null)
...
insert into attacks values (108, "Knock Off", "Discard a random card from your opponent's hand.", null)
...
insert into attacks values (109, "Gale Roundhouse", "If your opponent has 5 or fewer cards in their hand, this attack does 60 more damage.", null)
...
insert into attacks values (110, "Leer", "Flip a coin. If heads, your opponent's Active Pokémon is now Paralyzed.", null)
...
insert into attacks values (111, "Diffuse Reflection", "This attack does 40 damage for each Special Energy attached to all of your opponent's Pokémon.", null)
insert into "cost" values (349, "Colorless", 0, 111, "attack"); 
insert into attacks values (112, "Power Gem", "", null)
...
insert into attacks values (115, "Form Ranks", "Search your deck for up to 2 Basic Pokémon and put them onto your Bench. Then, shuffle your deck.", null)
insert into "cost" values (361, "Colorless", 0, 115, "attack"); 
insert into attacks values (116, "All-Out Attack", "If this Pokémon used Form Ranks during your last turn, this attack does 90 more damage.", null)
...
insert into attacks values (117, "Block Hammer", "During your opponent's next turn, this Pokémon takes 60 less damage from attacks (after applying Weakness and Resistance).", null)
...
insert into attacks values (118, "Resolute Fang", "If your opponent's Active Pokémon is a Pokémon ex, this attack does 70 more damage.", null)
...
insert into attacks values (119, "Drool", "", null)
insert into "cost" values (377, "Darkness", 0, 119, "attack"); 
insert into attacks values (120, "Super Poison Breath", "Your opponent's Active Pokémon is now Poisoned.", null)
...
insert into attacks values (121, "Devouring Mouth", "If this Pokémon has more Energy attached than your opponent's Active Pokémon, this attack does 160 more damage.", null)
insert into "cost" values (383, "Darkness", 0, 121, "attack"); 
insert into attacks values (122, "Venomous Hit", "Your opponent's Active Pokémon is now Poisoned.", null)
...
insert into attacks values (123, "Pull", "Switch in 1 of your opponent's Benched Pokémon to the Active Spot.", null)
insert into "cost" values (390, "Darkness", 0, 123, "attack"); 
insert into attacks values (124, "Tantrum", "This Pokémon is now Confused.", null)
...
insert into attacks values (125, "Smack", "", null)
insert into "cost" values (397, "Colorless", 0, 125, "attack"); 
insert into attacks values (126, "Claw Slash", "", null)
...
insert into attacks values (127, "Darkness Fang", "", null)
...
insert into attacks values (128, "Goad 'n' Grab", "Switch out your opponent's Active Pokémon to the Bench. (Your opponent chooses the new Active Pokémon.) If you do, this attack does 160 damage to the new Active Pokémon.", null)
insert into "cost" values (406, "Colorless", 0, 128, "attack"); 
insert into "cost" values (407, "Colorless", 1, 128, "attack"); 
insert into attacks values (129, "Knuckle Sandwich", "Discard 2 Energy from this Pokémon.", null)
...
insert into attacks values (130, "Swelling Wish", "Attach a Basic Energy card from your discard pile to 1 of your Benched Pokémon.", null)
insert into "cost" values (415, "Colorless", 0, 130, "attack"); 
insert into attacks values (131, "Slap", "", null)
...
insert into attacks values (132, "Allure", "Draw a card.", null)
insert into "cost" values (419, "Colorless", 0, 132, "attack"); 
insert into attacks values (133, "Beam", "", null)
...
insert into attacks values (134, "Iron Tackle", "This Pokémon also does 20 damage to itself.", null)
...
insert into attacks values (135, "Hyper Ray", "Discard all Energy from this Pokémon.", null)
...
insert into attacks values (136, "Knickknack Carrying", "Search your deck for a Pokémon Tool card, reveal it, and put it into your hand. Then, shuffle your deck.", null)
...
insert into attacks values (137, "Wrack Down", "", null)
insert into "cost" values (437, "Colorless", 0, 137, "attack"); 
insert into "cost" values (438, "Colorless", 1, 137, "attack"); 
insert into attacks values (138, "Reforged Axe", "Before doing damage, discard all Pokémon Tools from this Pokémon. If you can't discard any, this attack does nothing.", null)
...
insert into attacks values (139, "Iron Swing", "Flip 2 coins. This attack does 100 damage for each heads.", null)
...
insert into attacks values (140, "Hammer In", "", null)
insert into "cost" values (452, "Metal", 0, 140, "attack"); 
insert into attacks values (141, "Raging Hammer", "This attack does 10 more damage for each damage counter on this Pokémon.", null)
...
insert into attacks values (142, "Iron Blaster", "During your next turn, this Pokémon can't attack.", null)
...
insert into attacks values (143, "Outta-Control Dash", "", null)
...
insert into attacks values (144, "Rock Tomb", "During your opponent's next turn, the Defending Pokémon can't retreat.", null)
...
insert into attacks values (145, "Thunderburst Storm", "This attack does 30 damage to 1 of your opponent's Pokémon for each Energy attached to this Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
insert into "cost" values (478, "Lightning", 0, 145, "attack"); 
insert into "cost" values (479, "Fighting", 1, 145, "attack"); 
insert into attacks values (146, "Dragon Headbutt", "", null)
...
insert into attacks values (147, "Gnaw", "", null)
...
insert into attacks values (148, "Triple Stab", "Flip 3 coins. This attack does 10 damage for each heads.", null)
...
insert into attacks values (149, "Speed Wing", "", null)
...
insert into attacks values (150, "Hook", "", null)
...
insert into attacks values (151, "Nyan Roll", "Flip a coin. If heads, during your opponent's next turn, prevent all damage from and effects of attacks done to this Pokémon.", null)
...
insert into attacks values (152, "Assault Landing", "If there is no Stadium in play, this attack does nothing.", null)
...
insert into attacks values (153, "Boundless Power", "During your next turn, this Pokémon can't attack.", null)
...
insert into attacks values (154, "Knuckle Punch", "", null)
insert into "cost" values (508, "Colorless", 0, 154, "attack"); 
insert into "cost" values (509, "Colorless", 1, 154, "attack"); 
insert into attacks values (155, "Storm Barrier", "During your opponent's next turn, this Pokémon takes 50 less damage from attacks (after applying Weakness and Resistance).", null)
...
insert into attacks values (156, "Send Back", "Switch out your opponent's Active Pokémon to the Bench. (Your opponent chooses the new Active Pokémon.)", null)
...
insert into attacks values (157, "Speed Dive", "", null)
...
insert into attacks values (158, "Aero Chase", "If the Retreat Cost of your opponent's Active Pokémon is ColorlessColorless or more, this attack does 110 more damage.", null)
...
insert into attacks values (159, "Knock Over", "You may discard a Stadium in play.", null)
...
insert into attacks values (160, "Rear Kick", "", null)
...
insert into attacks values (161, "Tail Snap", "", null)
insert into "cost" values (528, "Colorless", 0, 161, "attack"); 
insert into attacks values (162, "Speed Attack", "", null)
...
insert into attacks values (163, "Unified Beatdown", "If you go second, you can't use this attack during your first turn. This attack does 30 damage for each of your Benched Pokémon.", null)
insert into "cost" values (532, "Colorless", 0, 163, "attack"); 
insert into "cost" values (533, "Colorless", 1, 163, "attack"); 
insert into attacks values (164, "Crown Opal", "During your opponent's next turn, prevent all damage done to this Pokémon by attacks from Basic non-Colorless Pokémon.", null)
...
insert into attacks values (165, "Leech Seed", "Heal 20 damage from this Pokémon.", null)
...
insert into attacks values (166, "Withdraw", "Flip a coin. If heads, during your opponent's next turn, prevent all damage done to this Pokémon by attacks.", null)
insert into "cost" values (549, "Water", 0, 166, "attack"); 
insert into attacks values (167, "Skull Bash", "", null)
...
insert into attacks values (168, "Precocious Evolution", "If you go first, you can use this attack during your first turn. Search your deck for a card that evolves from this Pokémon and put it onto this Pokémon to evolve it. Then, shuffle your deck.", null)
...
insert into attacks values (169, "Absorb", "Heal 10 damage from this Pokémon.", null)
...
insert into attacks values (170, "Barrage O'Clock", "Flip a coin for each Energy attached to both Active Pokémon. This attack does 60 damage for each heads.", null)
...
insert into attacks values (171, "Vengeful Crush", "This attack does 30 more damage for each Prize card your opponent has taken.", null)
...
insert into attacks values (172, "Wander About", "Switch this Pokémon with 1 of your Benched Pokémon.", null)
...
insert into attacks values (173, "Evo-Powder", "For each of your Benched Pokémon, search your deck for a card that evolves from that Pokémon and put it onto that Pokémon to evolve it. Then, shuffle your deck.", null)
insert into "cost" values (604, "Colorless", 0, 173, "attack"); 
insert into attacks values (174, "Cutting Wind", "", null)
...
insert into attacks values (175, "Attach", "", null)
...
insert into attacks values (176, "Spiral Rush", "Flip a coin until you get tails. This attack does 30 more damage for each heads.", null)
...
insert into attacks values (177, "Rescue Kedge", "Put up to 2 Pokémon from your discard pile into your hand.", null)
insert into "cost" values (613, "Colorless", 0, 177, "attack"); 
insert into attacks values (178, "Annihilating Anchor", "Before doing damage, discard all Pokémon Tools from your opponent's Active Pokémon.", null)
...
insert into attacks values (179, "Leaf Drain", "Heal 20 damage from this Pokémon.", null)
insert into "cost" values (620, "Grass", 0, 179, "attack"); 
insert into attacks values (180, "Jungle Whip", "You may put all Energy attached to this Pokémon into your hand to have this attack do 80 more damage.", null)
...
insert into attacks values (181, "Triple Draw", "Draw 3 cards.", null)
insert into "cost" values (627, "Colorless", 0, 181, "attack"); 
insert into attacks values (182, "Counterturn", "If there are 3 or fewer cards in your deck, this attack does 200 more damage.", null)
...
insert into attacks values (183, "Hazardous Greed", "If there are 3 or fewer cards in your deck, this attack also does 120 damage to 2 of your opponent's Benched Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
insert into "cost" values (630, "Grass", 0, 183, "attack"); 
insert into "cost" values (631, "Colorless", 1, 183, "attack"); 
insert into attacks values (184, "Entangling Whip", "Discard the top 3 cards of your deck.", null)
...
insert into attacks values (185, "Take Down", "This Pokémon also does 10 damage to itself.", null)
...
insert into attacks values (186, "Fire Soul", "This attack also does 30 damage to 1 of your opponent's Benched Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
...
insert into attacks values (187, "Spirited Tackle", "If your opponent's Active Pokémon is a Stage 1 Pokémon, this attack does 90 more damage.", null)
...
insert into attacks values (188, "Flap", "", null)
insert into "cost" values (647, "Fire", 0, 188, "attack"); 
insert into "cost" values (648, "Colorless", 1, 188, "attack"); 
insert into attacks values (189, "Shining Blaze", "If you have any Tera Pokémon on your Bench, this attack does 100 more damage.", null)
...
insert into attacks values (190, "Singe", "Your opponent's Active Pokémon is now Burned.", null)
insert into "cost" values (654, "Fire", 0, 190, "attack"); 
insert into attacks values (191, "Sunny Assist", "Move all Energy from this Pokémon to 1 of your Benched Pokémon.", null)
...
insert into attacks values (192, "Steady Firebreathing", "", null)
...
insert into attacks values (193, "Leech Life", "Heal from this Pokémon the same amount of damage you did to your opponent's Active Pokémon.", null)
insert into "cost" values (664, "Colorless", 0, 193, "attack"); 
insert into attacks values (194, "Turbulent Wings", "This Pokémon also does 50 damage to itself.", null)
...
insert into attacks values (195, "Energy Assist", "Attach up to 2 Basic Energy cards from your discard pile to 1 of your Benched Pokémon.", null)
insert into "cost" values (670, "Fire", 0, 195, "attack"); 
insert into attacks values (196, "Fireworks", "Discard an Energy from this Pokémon.", null)
...
insert into attacks values (197, "Live Coal", "", null)
...
insert into attacks values (198, "Billowing Heat Wave", "This attack also does 30 damage to each of your Benched Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
...
insert into attacks values (199, "Heat Burn", "Your opponent's Active Pokémon is now Burned.", null)
...
insert into attacks values (200, "Heat Breath", "Flip a coin. If heads, this attack does 50 more damage.", null)
...
insert into attacks values (201, "Torcherto", "This attack does 20 more damage for each Benched Pokémon (both yours and your opponent's).", null)
...
insert into attacks values (202, "Will-O-Wisp", "", null)
...
insert into attacks values (203, "Light Punch", "", null)
...
insert into attacks values (204, "Crimson Blaster", "Discard all Fire Energy from this Pokémon, and this attack does 180 damage to 1 of your opponent's Benched Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
...
insert into attacks values (205, "Cursed Edge", "Discard all Special Energy from all of your opponent's Pokémon.", null)
insert into "cost" values (703, "Colorless", 0, 205, "attack"); 
insert into attacks values (206, "Black Blaze Slash", "During your next turn, this Pokémon can't attack.", null)
...
insert into attacks values (207, "Abyssal Flames", "This attack does 20 more damage for each Energy card in your discard pile.", null)
insert into "cost" values (709, "Fire", 0, 207, "attack"); 
insert into attacks values (208, "Raging Amethyst", "Discard all Energy from this Pokémon.", null)
...
insert into attacks values (209, "Spicy Rage", "This attack does 70 more damage for each damage counter on this Pokémon.", null)
...
insert into attacks values (210, "Lunge Out", "", null)
insert into "cost" values (719, "Fire", 0, 210, "attack"); 
insert into attacks values (211, "Blazing Charge", "If your opponent has 4 or fewer Prize cards remaining, this attack does 70 more damage.", null)
...
insert into attacks values (212, "Upthrusting Horns", "You may put 2 Energy attached to your opponent's Active Stage 2 Pokémon into their hand.", null)
insert into "cost" values (725, "Colorless", 0, 212, "attack"); 
insert into "cost" values (726, "Colorless", 1, 212, "attack"); 
insert into attacks values (213, "Jet Headbutt", "", null)
...
insert into attacks values (214, "Aqua Dive", "This attack does 50 damage to 1 of your opponent's Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
...
insert into attacks values (215, "Leap Out", "Switch this Pokémon with 1 of your Benched Pokémon.", null)
...
insert into attacks values (216, "Hypno Splash", "Your opponent's Active Pokémon is now Asleep.", null)
...
insert into attacks values (217, "Powder Snow", "Your opponent's Active Pokémon is now Asleep.", null)
...
insert into attacks values (218, "Ice Ball", "", null)
...
insert into attacks values (219, "Frigid Fangs", "During your opponent's next turn, Pokémon that have 2 or less Energy attached can't attack. (This includes new Pokémon that come into play.)", null)
insert into "cost" values (750, "Water", 0, 219, "attack"); 
insert into attacks values (220, "Megaton Fall", "This Pokémon also does 50 damage to itself.", null)
...
insert into attacks values (221, "Call Sign", "Search your deck for a Pokémon, reveal it, and put it into your hand. Then, shuffle your deck.", null)
insert into "cost" values (758, "Water", 0, 221, "attack"); 
insert into attacks values (222, "Ice Beam", "Flip a coin. If heads, your opponent's Active Pokémon is now Paralyzed.", null)
...
insert into attacks values (223, "Ice Age", "If your opponent's Active Pokémon is a Dragon Pokémon, it is now Paralyzed.", null)
...
insert into attacks values (224, "Black Frost", "This Pokémon also does 30 damage to itself.", null)
...
insert into attacks values (225, "Big Bite", "During your opponent's next turn, the Defending Pokémon can't retreat.", null)
...
insert into attacks values (226, "Aerial Ace", "Flip a coin. If heads, this attack does 20 more damage.", null)
...
insert into attacks values (227, "Aqua Edge", "", null)
...
insert into attacks values (228, "Hydro Splash", "", null)
...
insert into attacks values (229, "Draining Fin", "Heal 20 damage from this Pokémon.", null)
...
insert into attacks values (230, "Dangerous Mouth", "", null)
...
insert into attacks values (231, "Gusting Collision", "This attack does 50 less damage for each Colorless in your opponent's Active Pokémon's Retreat Cost.", null)
...
insert into attacks values (232, "Icicle Loop", "Put an Energy attached to this Pokémon into your hand.", null)
...
insert into attacks values (233, "Topaz Bolt", "Discard 3 Energy from this Pokémon.", null)
...
insert into attacks values (234, "Lightning Ball", "", null)
...
insert into attacks values (235, "Electric Ball", "", null)
...
insert into attacks values (236, "Mighty Magnetism", "Your opponent's Active Pokémon is now Confused. During your opponent's next turn, that Pokémon can't retreat.", null)
...
insert into attacks values (237, "Zap Cannon", "During your next turn, this Pokémon can't use Zap Cannon.", null)
...
insert into attacks values (238, "Crushing Pulse", "Your opponent reveals their hand. Discard all Item cards and Pokémon Tool cards you find there.", null)
insert into "cost" values (821, "Lightning", 0, 238, "attack"); 
insert into attacks values (239, "Energy Short", "This attack does 20 damage for each Energy attached to your opponent's Active Pokémon.", null)
...
insert into attacks values (240, "Add On", "Draw a card.", null)
insert into "cost" values (824, "Colorless", 0, 240, "attack"); 
insert into attacks values (241, "Static Shock", "", null)
...
insert into attacks values (242, "Kick", "", null)
insert into "cost" values (828, "Lightning", 0, 242, "attack"); 
insert into attacks values (243, "Mach Bolt", "", null)
...
insert into attacks values (244, "Paralyzing Crackle", "Flip a coin. If heads, your opponent's Active Pokémon is now Paralyzed, and discard an Energy from that Pokémon.", null)
...
insert into attacks values (245, "Summon Lightning", "Search your deck for up to 2 Lightning Pokémon, reveal them, and put them into your hand. Then, shuffle your deck.", null)
insert into "cost" values (837, "Colorless", 0, 245, "attack"); 
insert into attacks values (246, "Prize Count", "If you have more Prize cards remaining than your opponent, this attack does 90 more damage.", null)
...
insert into attacks values (247, "Glide", "", null)
insert into "cost" values (843, "Colorless", 0, 247, "attack"); 
insert into "cost" values (844, "Colorless", 1, 247, "attack"); 
insert into attacks values (248, "Storm Bolt", "Move all Energy from this Pokémon to your Benched Pokémon in any way you like.", null)
...
insert into attacks values (249, "Return Charge", "Switch this Pokémon with 1 of your Benched Pokémon. If you do, attach up to 2 Basic Lightning Energy cards from your hand to this Pokémon.", null)
insert into "cost" values (849, "Lightning", 0, 249, "attack"); 
insert into attacks values (250, "Thunder Lance", "This attack does 40 more damage for each Lightning Energy attached to this Pokémon.", null)
...
insert into attacks values (251, "C.O.D.E.: Protect", "During your opponent's next turn, prevent all damage done to each of your Future Pokémon by attacks from Pokémon ex. If this Pokémon is no longer your Active Pokémon, this effect ends.", null)
insert into "cost" values (852, "Lightning", 0, 251, "attack"); 
insert into "cost" values (853, "Colorless", 1, 251, "attack"); 
insert into attacks values (252, "Thunder Claws", "", null)
...
insert into attacks values (253, "Pound", "", null)
...
insert into attacks values (254, "Draining Kiss", "Heal 30 damage from this Pokémon.", null)
...
insert into attacks values (255, "Rolling Tackle", "", null)
...
insert into attacks values (256, "Double-Edge", "This Pokémon also does 50 damage to itself.", null)
...
insert into attacks values (257, "Delightful Kiss", "Search your deck for up to 2 Basic Psychic Energy cards and attach them to 1 of your Benched Pokémon. Then, shuffle your deck.", null)
...
insert into attacks values (258, "Eon Blade", "During your next turn, this Pokémon can't attack.", null)
...
insert into attacks values (259, "Skill Dive", "This attack does 50 damage to 1 of your opponent's Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
...
insert into attacks values (260, "Painful Memories", "Put 2 damage counters on each of your opponent's Pokémon.", null)
...
insert into attacks values (261, "Full Heart", "Attach up to 2 Basic Psychic Energy cards from your hand to your Pokémon in any way you like.", null)
insert into "cost" values (884, "Colorless", 0, 261, "attack"); 
insert into attacks values (262, "Guardian Burst", "If you don't have Uxie and Azelf on your Bench, this attack does nothing.", null)
...
insert into attacks values (263, "Neurokinesis", "This attack does 10 more damage for each damage counter on all of your opponent's Pokémon.", null)
...
insert into attacks values (264, "Double Draw", "Draw 2 cards.", null)
insert into "cost" values (891, "Colorless", 0, 264, "attack"); 
insert into attacks values (265, "Psy Bolt", "Flip a coin. If heads, your opponent's Active Pokémon is now Paralyzed.", null)
...
insert into attacks values (266, "Petty Grudge", "", null)
...
insert into attacks values (267, "Law of the Underworld", "Put 6 damage counters on each Pokémon that has an Ability (both yours and your opponent's).", null)
insert into "cost" values (900, "Psychic", 0, 267, "attack"); 
insert into attacks values (268, "Spooky Shot", "", null)
...
insert into attacks values (269, "See Through", "Your opponent reveals their hand.", null)
insert into "cost" values (906, "Colorless", 0, 269, "attack"); 
insert into attacks values (270, "Psyshot", "", null)
...
insert into attacks values (271, "Magical Charm", "During your opponent's next turn, attacks used by the Defending Pokémon do 100 less damage (before applying Weakness and Resistance).", null)
...
insert into attacks values (272, "Angelite", "Choose 2 of your opponent's Benched Pokémon. Shuffle those Pokémon and all attached cards into your opponent's deck. If 1 of your Pokémon used Angelite during your last turn, this attack can't be used.", null)
...
insert into attacks values (273, "Electromagnetic Sonar", "Put a Trainer card from your discard pile into your hand.", null)
...
insert into attacks values (274, "Aurora Gain", "Heal 30 damage from this Pokémon.", null)
insert into "cost" values (921, "Psychic", 0, 274, "attack"); 
insert into "cost" values (922, "Colorless", 1, 274, "attack"); 
insert into attacks values (275, "Giga Impact", "During your next turn, this Pokémon can't attack.", null)
...
insert into attacks values (276, "Dazzle Dance", "Your opponent's Active Pokémon is now Confused.", null)
...
insert into attacks values (277, "Sand Spray", "", null)
...
insert into attacks values (278, "Sand Tomb", "During your opponent's next turn, the Defending Pokémon can't retreat.", null)
...
insert into attacks values (279, "Barite Jail", "Put damage counters on each of your opponent's Benched Pokémon until its remaining HP is 100.", null)
...
insert into attacks values (280, "Perplex", "Your opponent's Active Pokémon is now Confused.", null)
insert into "cost" values (947, "Colorless", 0, 280, "attack"); 
insert into "cost" values (948, "Colorless", 1, 280, "attack"); 
insert into attacks values (281, "Mental Crush", "If your opponent's Active Pokémon is Confused, this attack does 90 more damage.", null)
...
insert into attacks values (282, "Splashing Dodge", "Flip a coin. If heads, during your opponent's next turn, prevent all damage from and effects of attacks done to this Pokémon.", null)
...
insert into attacks values (283, "Mystical Eyes", "Devolve 1 of your opponent's evolved Pokémon by putting the highest Stage Evolution card on it into your opponent's hand.", null)
insert into "cost" values (956, "Colorless", 0, 283, "attack"); 
insert into attacks values (284, "Spiral Drain", "Heal 30 damage from this Pokémon.", null)
...
insert into attacks values (285, "Perplexing Transfer", "Move all damage counters from 1 of your Benched Ancient Pokémon to your opponent's Active Pokémon.", null)
insert into "cost" values (960, "Colorless", 0, 285, "attack"); 
insert into "cost" values (961, "Colorless", 1, 285, "attack"); 
insert into attacks values (286, "Moonblast", "During your opponent's next turn, attacks used by the Defending Pokémon do 30 less damage (before applying Weakness and Resistance).", null)
...
insert into attacks values (287, "Minor Errand-Running", "Search your deck for up to 2 Basic Energy cards, reveal them, and put them into your hand. Then, shuffle your deck.", null)
...
insert into attacks values (288, "Dual Chop", "Flip 2 coins. This attack does 10 damage for each heads.", null)
...
insert into attacks values (289, "Sweep the Leg", "Flip a coin. If heads, discard an Energy from your opponent's Active Pokémon.", null)
insert into "cost" values (970, "Fighting", 0, 289, "attack"); 
insert into attacks values (290, "Mega Punch", "", null)
...
insert into attacks values (291, "Destined Fight", "Both Active Pokémon are Knocked Out.", null)
...
insert into attacks values (292, "Smash Kick", "", null)
insert into "cost" values (979, "Fighting", 0, 292, "attack"); 
insert into "cost" values (980, "Colorless", 1, 292, "attack"); 
insert into attacks values (293, "Blocking Stomp", "If the Defending Pokémon is a Basic Pokémon, it can't attack during your opponent's next turn.", null)
...
insert into attacks values (294, "Knock Flat", "This attack's damage isn't affected by any effects on your opponent's Active Pokémon.", null)
insert into "cost" values (988, "Fighting", 0, 294, "attack"); 
insert into attacks values (295, "Guarded Rolling", "Discard 2 Energy from this Pokémon. During your opponent's next turn, this Pokémon takes 100 less damage from attacks (after applying Weakness and Resistance).", null)
...
insert into attacks values (296, "Screech", "During your next turn, the Defending Pokémon takes 50 more damage from attacks (after applying Weakness and Resistance).", null)
...
insert into attacks values (297, "Reversing Storm", "You may switch this Pokémon with 1 of your Benched Pokémon.", null)
insert into "cost" values (999, "Fighting", 0, 297, "attack"); 
insert into attacks values (298, "Sonic Peridot", "This attack does 100 damage to each of your opponent's Pokémon ex and Pokémon V. This attack's damage isn't affected by Weakness or Resistance.", null)
...
insert into attacks values (299, "Mud Shot", "", null)
...
insert into attacks values (300, "Burrow", "Discard the top card of your opponent's deck.", null)
insert into "cost" values (1010, "Colorless", 0, 300, "attack"); 
insert into attacks values (301, "Mud-Slap", "", null)
...
insert into attacks values (302, "Digging Claw", "Discard the top card of your opponent's deck.", null)
insert into "cost" values (1014, "Colorless", 0, 302, "attack"); 
insert into attacks values (303, "Drill Smash", "If you have any Metal Pokémon on your Bench, this attack does 80 more damage.", null)
...
insert into attacks values (304, "Fist of Focus", "Attach an Energy card from your discard pile to this Pokémon.", null)
insert into "cost" values (1019, "Fighting", 0, 304, "attack"); 
insert into attacks values (305, "Buster Swing", "This attack's damage isn't affected by Resistance.", null)
...
insert into attacks values (306, "Coordinated Throwing", "This attack does 20 damage for each of your Basic Pokémon in play.", null)
...
insert into attacks values (307, "Slight Intrusion", "This Pokémon also does 10 damage to itself.", null)
...
insert into attacks values (308, "Raging Tentacles", "If this Pokémon has any damage counters on it, this attack can be used for Fighting.", null)
...
insert into attacks values (309, "Rock Hurl", "This attack's damage isn't affected by Resistance.", null)
...
insert into attacks values (310, "Corrosive Shards", "Your opponent's Active Pokémon is now Poisoned. During your opponent's next turn, Energy cards can't be attached from your opponent's hand to that Pokémon.", null)
insert into "cost" values (1041, "Colorless", 0, 310, "attack"); 
insert into attacks values (311, "Rock Throw", "", null)
...
insert into attacks values (312, "Unrelenting Onslaught", "If 1 of your other Ancient Pokémon used an attack during your last turn, this attack does 150 more damage.", null)
...
insert into attacks values (313, "Stomp Off", "Discard the top card of your opponent's deck.", null)
...
insert into attacks values (314, "Crashing Headbutt", "Discard the top 3 cards of your opponent's deck.", null)
insert into "cost" values (1054, "Darkness", 0, 314, "attack"); 
insert into "cost" values (1055, "Colorless", 1, 314, "attack"); 
insert into attacks values (315, "Obsidian", "This attack also does 130 damage to 2 of your opponent's Benched Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
...
insert into attacks values (316, "Mischievous Painting", "Attach up to 3 Energy cards from your opponent's discard pile to their Pokémon in any way you like.", null)
insert into "cost" values (1064, "Colorless", 0, 316, "attack"); 
insert into attacks values (317, "Energized Graffiti", "This attack does 40 damage for each Energy attached to all of your opponent's Pokémon.", null)
...
insert into attacks values (318, "Surprise Attack", "Flip a coin. If tails, this attack does nothing.", null)
...
insert into attacks values (319, "Trio-Cheehoo", "If you don't have exactly 3 cards in your hand, this attack does nothing.", null)
...
insert into attacks values (320, "Steel Wing", "During your opponent's next turn, this Pokémon takes 30 less damage from attacks (after applying Weakness and Resistance).", null)
...
insert into attacks values (321, "Shield Attack", "Flip a coin. If heads, this attack does 20 more damage.", null)
...
insert into attacks values (322, "Spinning Attack", "", null)
insert into "cost" values (1080, "Metal", 0, 322, "attack"); 
insert into "cost" values (1081, "Colorless", 1, 322, "attack"); 
insert into attacks values (323, "Double Impact", "Flip 2 coins. This attack does 100 damage for each heads.", null)
...
insert into attacks values (324, "Stick 'n' Draw", "Discard a card from your hand. If you do, draw 2 cards.", null)
...
insert into attacks values (325, "Confront", "", null)
insert into "cost" values (1090, "Metal", 0, 325, "attack"); 
insert into "cost" values (1091, "Metal", 1, 325, "attack"); 
insert into attacks values (326, "Duralubeam", "Discard 2 Energy from this Pokémon.", null)
...
insert into attacks values (327, "Metal Defender", "During your opponent's next turn, this Pokémon has no Weakness.", null)
...
insert into attacks values (328, "Strike It Rich", "If this Pokémon evolved from Gimmighoul during this turn, this attack does 90 more damage.", null)
insert into "cost" values (1102, "Metal", 0, 328, "attack"); 
insert into attacks values (329, "Surf Back", "You may shuffle this Pokémon and all attached cards into your deck.", null)
...
insert into attacks values (330, "Deleting Slash", "If your opponent has 3 or more Benched Pokémon, this attack does 80 more damage.", null)
insert into "cost" values (1108, "Metal", 0, 330, "attack"); 
insert into "cost" values (1109, "Colorless", 1, 330, "attack"); 
insert into attacks values (331, "Slicing Blade", "", null)
...
insert into attacks values (332, "Tropical Frenzy", "You may attach any number of Basic Energy cards from your hand to your Pokémon in any way you like.", null)
insert into "cost" values (1115, "Grass", 0, 332, "attack"); 
insert into "cost" values (1116, "Water", 1, 332, "attack"); 
insert into attacks values (333, "Swinging Sphene", "Flip a coin. If heads, Knock Out your opponent's Active Basic Pokémon. If tails, Knock Out 1 of your opponent's Benched Basic Pokémon.", null)
...
insert into attacks values (334, "Humming Charge", "Search your deck for up to 2 Basic Energy cards and attach them to your Pokémon in any way you like. Then, shuffle your deck.", null)
insert into "cost" values (1123, "Water", 0, 334, "attack"); 
insert into attacks values (335, "Cotton Wings", "Flip a coin. If heads, during your opponent's next turn, prevent all damage done to this Pokémon by attacks.", null)
...
insert into attacks values (336, "Time Manipulation", "Search your deck for 2 cards, shuffle your deck, then put those cards on top of it in any order.", null)
insert into "cost" values (1127, "Colorless", 0, 336, "attack"); 
insert into attacks values (337, "Buster Tail", "", null)
...
insert into attacks values (338, "Space Crash", "This attack does 40 damage for each Basic Energy attached to this Pokémon.", null)
...
insert into attacks values (339, "Fully Singe", "Discard an Energy from your opponent's Active Pokémon ex.", null)
insert into "cost" values (1137, "Fire", 0, 339, "attack"); 
insert into attacks values (340, "Steaming Stomp", "", null)
...
insert into attacks values (341, "Nutrients", "Heal 30 damage from 1 of your Pokémon.", null)
insert into "cost" values (1144, "Colorless", 0, 341, "attack"); 
insert into attacks values (342, "Trip Over", "Flip a coin. If heads, this attack does 30 more damage.", null)
...
insert into attacks values (343, "Acidic Spit", "This attack does 20 damage for each damage counter on your opponent's Active Pokémon.", null)
...
insert into attacks values (344, "Melting Sweetness", "During your opponent's next turn, the Defending Pokémon can't attack.", null)
insert into "cost" values (1150, "Colorless", 0, 344, "attack"); 
insert into "cost" values (1151, "Colorless", 1, 344, "attack"); 
insert into attacks values (345, "Wild Tackle", "This Pokémon also does 20 damage to itself.", null)
...
insert into attacks values (346, "Dyna-Blast", "If your opponent's Active Pokémon is a Pokémon ex, this attack does 80 more damage.", null)
insert into "cost" values (1157, "Darkness", 0, 346, "attack"); 
insert into attacks values (347, "World Ender", "Discard a Stadium in play. If you can't, this attack does nothing.", null)
...
insert into attacks values (348, "Surprise Pump", "This attack's damage isn't affected by any effects on your opponent's Active Pokémon.", null)
insert into "cost" values (1163, "Fire", 0, 348, "attack"); 
insert into "cost" values (1164, "Water", 1, 348, "attack"); 
insert into attacks values (349, "Cinnabar Lure", "Look at the top 10 cards of your deck. You may put any number of Pokémon you find there onto your Bench. Shuffle the other cards back into your deck.", null)
...
insert into attacks values (350, "Spike Draw", "Draw a card.", null)
...
insert into attacks values (351, "Take It Easy", "Heal 60 damage from this Pokémon. During your next turn, this Pokémon can't retreat.", null)
...
insert into attacks values (352, "Slashing Claw", "", null)
...
insert into attacks values (353, "Great Swing", "Discard an Energy from this Pokémon.", null)
...
insert into attacks values (354, "Disarming Voice", "Your opponent's Active Pokémon is now Confused.", null)
...
insert into attacks values (355, "Fury Cutter", "Flip 3 coins. If 1 of them is heads, this attack does 20 more damage. If 2 of them are heads, this attack does 50 more damage. If all of them are heads, this attack does 80 more damage.", null)
...
insert into attacks values (356, "Lick Whip", "This attack does 30 damage to 1 of your opponent's Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
...
insert into attacks values (357, "Ready to Ram", "During your opponent's next turn, if this Pokémon is damaged by an attack (even if this Pokémon is Knocked Out), put 6 damage counters on the Attacking Pokémon.", null)
insert into "cost" values (1194, "Colorless", 0, 357, "attack"); 
insert into "cost" values (1195, "Colorless", 1, 357, "attack"); 
insert into attacks values (358, "Smashing Headbutt", "Discard 2 Energy from this Pokémon.", null)
...
insert into attacks values (359, "Drag Off", "Switch in 1 of your opponent's Benched Pokémon to the Active Spot. This attack does 40 damage to the new Active Pokémon.", null)
insert into "cost" values (1203, "Colorless", 0, 359, "attack"); 
insert into "cost" values (1204, "Colorless", 1, 359, "attack"); 
insert into attacks values (360, "Blasting Wind", "", null)
...
insert into attacks values (361, "Tiny Bolt", "", null)
...
insert into attacks values (362, "Parabolic Charge", "Search your deck for up to 4 Energy cards, reveal them, and put them into your hand. Then, shuffle your deck.", null)
...
insert into attacks values (363, "Now You're in My Power", "Until the end of your next turn, the Defending Pokémon's Weakness is now Colorless. (The amount of Weakness doesn't change.)", null)
...
insert into attacks values (364, "Familial March", "Search your deck for up to 2 in any combination of Maushold and Maushold ex and put them onto your Bench. Then, shuffle your deck.", null)
insert into "cost" values (1217, "Colorless", 0, 364, "attack"); 
insert into attacks values (365, "Incessant Incisors", "Flip 4 coins. This attack does 30 damage for each heads.", null)
...
insert into attacks values (366, "Break Through", "This attack also does 30 damage to 1 of your opponent's Benched Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
...
insert into attacks values (367, "Zircon Road", "You may draw 5 cards.", null)
...
insert into attacks values (368, "Precise Beak", "If this Pokémon and your opponent's Active Pokémon have the same amount of Energy attached, this attack does 100 more damage.", null)
insert into "cost" values (1227, "Colorless", 0, 368, "attack"); 
insert into "cost" values (1228, "Colorless", 1, 368, "attack"); 
insert into attacks values (369, "Brave Bird", "This Pokémon also does 30 damage to itself.", null)
...
insert into attacks values (370, "Prism Charge", "Search your deck for up to 3 Basic Energy cards of different types and attach them to your Tera Pokémon in any way you like. Then, shuffle your deck.", null)
insert into "cost" values (1234, "Colorless", 0, 370, "attack"); 
insert into attacks values (371, "Hard Tackle", "", null)
...
insert into attacks values (372, "Fluorite", "Discard all Energy from this Pokémon, and heal all damage from each of your Tera Pokémon.", null)
...
insert into attacks values (373, "Solar Beam", "", null)
...
insert into attacks values (374, "Slash", "", null)
...
insert into attacks values (375, "Itchy Pollen", "During your opponent's next turn, they can't play any Item cards from their hand.", null)
...
insert into attacks values (376, "Leaflet Blessings", "Attach a Basic Grass Energy card from your hand to 1 of your Benched Pokémon. If you do, heal all damage from that Pokémon.", null)
...
insert into attacks values (377, "Verdant Storm", "This attack does 60 damage for each Energy attached to all of your opponent's Pokémon.", null)
insert into "cost" values (1343, "Grass", 0, 377, "attack"); 
insert into "cost" values (1344, "Colorless", 1, 377, "attack"); 
insert into attacks values (378, "Moss Agate", "Heal 100 damage from each of your Benched Pokémon.", null)
...
insert into attacks values (379, "Triple Spin", "Flip 3 coins. This attack does 10 damage for each heads.", null)
...
insert into attacks values (380, "Seed Bomb", "", null)
...
insert into attacks values (381, "Do the Wave", "This attack does 20 damage for each of your Benched Pokémon.", null)
...
insert into attacks values (382, "Myriad Leaf Shower", "This attack does 30 more damage for each Energy attached to both Active Pokémon.", null)
...
insert into attacks values (383, "Destructive Flame", "Flip a coin. If heads, discard an Energy from your opponent's Active Pokémon.", null)
insert into "cost" values (1365, "Fire", 0, 383, "attack"); 
insert into attacks values (384, "Fighting Blaze", "If your opponent's Active Pokémon is a Pokémon ex or Pokémon V, this attack does 90 more damage.", null)
...
insert into attacks values (385, "Burning Charge", "Search your deck for up to 2 Basic Energy cards and attach them to 1 of your Pokémon. Then, shuffle your deck.", null)
insert into "cost" values (1371, "Fire", 0, 385, "attack"); 
insert into "cost" values (1372, "Colorless", 1, 385, "attack"); 
insert into attacks values (386, "Carnelian", "During your next turn, this Pokémon can't attack.", null)
...
insert into attacks values (387, "Fire Mane", "", null)
insert into "cost" values (1379, "Fire", 0, 387, "attack"); 
insert into "cost" values (1380, "Colorless", 1, 387, "attack"); 
insert into attacks values (388, "Flame Tackle", "During your next turn, this Pokémon can't attack.", null)
...
insert into attacks values (389, "Wrathful Hearth", "This attack does 20 damage for each damage counter on this Pokémon.", null)
...
insert into attacks values (390, "Dynamic Blaze", "If your opponent's Active Pokémon is an Evolution Pokémon, this attack does 140 more damage, and discard all Energy from this Pokémon.", null)
...
insert into attacks values (391, "Tail Whap", "", null)
...
insert into attacks values (392, "Wash the Slate Clean", "You may put 2 Energy attached to your opponent's Active Pokémon into their hand.", null)
...
insert into attacks values (393, "Whirlpool", "Flip a coin. If heads, discard an Energy from your opponent's Active Pokémon.", null)
...
insert into attacks values (394, "Rapid Draw", "Draw 2 cards.", null)
...
insert into attacks values (395, "Fighting Whirlpool", "If your opponent's Active Pokémon is a Pokémon ex or Pokémon V, this attack does 90 more damage.", null)
...
insert into attacks values (396, "Severe Squall", "This attack does 60 damage to each of your opponent's Pokémon ex. This attack's damage isn't affected by Weakness or Resistance.", null)
insert into "cost" values (1412, "Water", 0, 396, "attack"); 
insert into "cost" values (1413, "Colorless", 1, 396, "attack"); 
insert into attacks values (397, "Aquamarine", "During your next turn, this Pokémon can't attack.", null)
...
insert into attacks values (398, "Overrun", "This attack also does 30 damage to 1 of your opponent's Benched Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
insert into "cost" values (1419, "Colorless", 0, 398, "attack"); 
insert into "cost" values (1420, "Colorless", 1, 398, "attack"); 
insert into attacks values (399, "Aurora Beam", "", null)
...
insert into attacks values (400, "Permeating Chill", "At the end of your opponent's next turn, put 9 damage counters on the Defending Pokémon.", null)
insert into "cost" values (1425, "Water", 0, 400, "attack"); 
insert into attacks values (401, "Icicle Missile", "", null)
...
insert into attacks values (402, "Frost Bullet", "This attack also does 30 damage to 1 of your opponent's Benched Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
insert into "cost" values (1429, "Water", 0, 402, "attack"); 
insert into "cost" values (1430, "Colorless", 1, 402, "attack"); 
insert into attacks values (403, "Euclase", "Knock Out 1 of your opponent's Pokémon that has exactly 6 damage counters on it.", null)
...
insert into attacks values (404, "Sob", "During your opponent's next turn, the Defending Pokémon can't retreat.", null)
insert into "cost" values (1435, "Colorless", 0, 404, "attack"); 
insert into attacks values (405, "Torrential Pump", "You may shuffle 3 Energy attached to this Pokémon into your deck. If you do, this attack also does 120 damage to 1 of your opponent's Benched Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
...
insert into attacks values (406, "Thunder", "This Pokémon also does 30 damage to itself.", null)
...
insert into attacks values (407, "Linear Attack", "This attack does 30 damage to 1 of your opponent's Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
insert into "cost" values (1444, "Lightning", 0, 407, "attack"); 
insert into attacks values (408, "Fighting Lightning", "If your opponent's Active Pokémon is a Pokémon ex or Pokémon V, this attack does 90 more damage.", null)
...
insert into attacks values (409, "Flashing Spear", "You may discard up to 2 Basic Energy from your Benched Pokémon. This attack does 90 more damage for each card you discarded in this way.", null)
insert into "cost" values (1448, "Lightning", 0, 409, "attack"); 
insert into "cost" values (1449, "Colorless", 1, 409, "attack"); 
insert into attacks values (410, "Dravite", "During your next turn, this Pokémon can't attack.", null)
...
insert into attacks values (411, "Arm Press", "", null)
...
insert into attacks values (412, "Amp You Very Much", "If your opponent's Pokémon is Knocked Out by damage from this attack, take 1 more Prize card.", null)
...
insert into attacks values (413, "Volt Cyclone", "Move an Energy from this Pokémon to 1 of your Benched Pokémon.", null)
...
insert into attacks values (414, "Psychic Assault", "This attack does 10 more damage for each damage counter on your opponent's Active Pokémon.", null)
...
insert into attacks values (415, "Psych Out", "Discard a random card from your opponent's hand.", null)
...
insert into attacks values (416, "Amazez", "Devolve each of your opponent's evolved Pokémon by shuffling the highest Stage Evolution card on it into your opponent's deck.", null)
...
insert into attacks values (417, "Come and Get You", "Put up to 3 Duskull from your discard pile onto your Bench.", null)
...
insert into attacks values (418, "Shadow Bind", "During your opponent's next turn, the Defending Pokémon can't retreat.", null)
...
insert into attacks values (419, "Fairy Wind", "", null)
...
insert into attacks values (420, "Perfume Press", "Your opponent's Active Pokémon is now Confused.", null)
...
insert into attacks values (421, "Roaring Scream", "This attack does 20 damage to 1 of your opponent's Pokémon for each damage counter on this Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
...
insert into attacks values (422, "Hex Hurl", "Put 2 damage counters on your opponent's Benched Pokémon in any way you like.", null)
...
insert into attacks values (423, "Mind Bend", "Your opponent's Active Pokémon is now Confused.", null)
...
insert into attacks values (424, "Energy Feather", "This attack does 30 damage for each Energy attached to this Pokémon.", null)
...
insert into attacks values (425, "Swelling Power", "Attach a Basic Fighting Energy card from your hand to 1 of your Pokémon.", null)
insert into "cost" values (1515, "Colorless", 0, 425, "attack"); 
insert into attacks values (426, "Magma Purge", "Discard up to 4 Energy from your Pokémon. This attack does 60 damage for each card you discarded in this way.", null)
...
insert into attacks values (427, "Aura Uppercut", "", null)
insert into "cost" values (1523, "Fighting", 0, 427, "attack"); 
insert into attacks values (428, "Tornado Rush", "During your next turn, this Pokémon's Tornado Rush attack does 100 more damage (before applying Weakness and Resistance).", null)
...
insert into attacks values (429, "Land Crush", "", null)
...
insert into attacks values (430, "Mad Bite", "This attack does 30 more damage for each damage counter on your opponent's Active Pokémon.", null)
...
insert into attacks values (431, "Land Collapse", "Discard the top card of your opponent's deck. If you played an Ancient Supporter card from your hand during this turn, discard 3 more cards in this way.", null)
insert into "cost" values (1545, "Colorless", 0, 431, "attack"); 
insert into "cost" values (1546, "Colorless", 1, 431, "attack"); 
insert into attacks values (432, "Giant Tusk", "", null)
...
insert into attacks values (433, "Earthen Spike", "During your next turn, this Pokémon can't attack.", null)
...
insert into attacks values (434, "Good Punch", "", null)
...
insert into attacks values (435, "Demolish", "This attack's damage isn't affected by Weakness or Resistance, or by any effects on your opponent's Active Pokémon.", null)
...
insert into attacks values (436, "Feint Attack", "This attack does 50 damage to 1 of your opponent's Pokémon. This attack's damage isn't affected by Weakness or Resistance, or by any effects on that Pokémon.", null)
insert into "cost" values (1567, "Darkness", 0, 436, "attack"); 
insert into attacks values (437, "Pitch-Black Blade", "During your next turn, this Pokémon can't attack.", null)
...
insert into attacks values (438, "Moon Mirage", "Your opponent's Active Pokémon is now Confused.", null)
...
insert into attacks values (439, "Onyx", "Discard all Energy from this Pokémon, and take a Prize card.", null)
...
insert into attacks values (440, "Playful Kick", "", null)
...
insert into attacks values (441, "Call to Muster", "Search your deck for up to 2 Basic Energy cards and attach them to your Pokémon in any way you like. Then, shuffle your deck.", null)
insert into "cost" values (1582, "Darkness", 0, 441, "attack"); 
insert into attacks values (442, "Pitch-Black Fangs", "", null)
...
insert into attacks values (443, "Grind", "This attack does 50 damage for each Energy attached to this Pokémon.", null)
insert into "cost" values (1587, "Colorless", 0, 443, "attack"); 
insert into attacks values (444, "Tyrannical Crush", "Discard a random card from your opponent's hand.", null)
...
insert into attacks values (445, "Vengeance Fletching", "This attack does 10 more damage for each Ancient card in your discard pile.", null)
...
insert into attacks values (446, "Heavy Impact", "", null)
...
insert into attacks values (447, "Iron Buster", "During your next turn, this Pokémon can't attack.", null)
...
insert into attacks values (448, "Phantom Dive", "Put 6 damage counters on your opponent's Benched Pokémon in any way you like.", null)
...
insert into attacks values (449, "Coruscating Quartz", "", null)
...
insert into attacks values (450, "Strength", "", null)
...
insert into attacks values (451, "Toss-and-Turn Press", "Flip 3 coins. This attack does 120 damage for each heads.", null)
...
insert into attacks values (452, "Dig", "Flip a coin. If heads, during your opponent's next turn, prevent all damage from and effects of attacks done to this Pokémon.", null)
...
insert into attacks values (453, "Moomoo Rolling", "You can use this attack only if this Pokémon used Rollout during your last turn.", null)
...
insert into attacks values (454, "Hyper Whirlpool", "Flip a coin until you get tails. For each heads, discard an Energy from your opponent's Active Pokémon.", null)
...
insert into attacks values (455, "Jewel Breaker", "If your opponent's Active Pokémon is a Tera Pokémon, this attack does 230 more damage.", null)
...
insert into attacks values (456, "Reflect Energy", "Move an Energy from this Pokémon to 1 of your Benched Pokémon.", null)
...
insert into attacks values (457, "Rising Tackle", "If your opponent's Active Pokémon is a Pokémon ex, this attack does 50 more damage.", null)
...
insert into attacks values (458, "Strafe", "You may switch this Pokémon with 1 of your Benched Pokémon.", null)
insert into "cost" values (1670, "Colorless", 0, 458, "attack"); 
insert into attacks values (459, "Sonic Blast", "This Pokémon also does 30 damage to itself.", null)
...
insert into attacks values (460, "Laser Blade", "During your next turn, this Pokémon can't attack.", null)
...
insert into attacks values (461, "Twin Shotels", "This attack does 50 damage to 2 of your opponent's Pokémon. This attack's damage isn't affected by Weakness or Resistance, or by any effects on those Pokémon.", null)
...
insert into attacks values (462, "Frenzied Gouging", "Knock Out your opponent's Active Pokémon. If your opponent's Active Pokémon is Knocked Out in this way, this Pokémon does 200 damage to itself.", null)
...
insert into attacks values (463, "Calamity Storm", "You may discard a Stadium in play. If you do, this attack does 120 more damage.", null)
...
insert into attacks values (464, "Irritated Outburst", "This attack does 60 damage for each Prize card your opponent has taken.", null)
...
insert into attacks values (465, "Make It Rain", "Discard any number of Basic Energy cards from your hand. This attack does 50 damage for each card you discarded in this way.", null)
...
insert into attacks values (466, "Burst Roar", "Discard your hand and draw 6 cards.", null)
insert into "cost" values (1728, "Colorless", 0, 466, "attack"); 
insert into attacks values (467, "Bellowing Thunder", "You may discard any amount of Basic Energy from your Pokémon. This attack does 70 damage for each card you discarded in this way.", null)
...
insert into attacks values (468, "Blood Moon", "During your next turn, this Pokémon can't attack.", null)
...
insert into attacks values (469, "Prism Edge", "During your next turn, this Pokémon can't attack.", null)
...
insert into attacks values (470, "Catharsis Roar", "If your opponent's Active Pokémon is affected by a Special Condition, this attack does 120 more damage.", null)
...
insert into attacks values (471, "Bug Bite", "", null)
...
insert into attacks values (472, "Harden", "During your opponent's next turn, prevent all damage done to this Pokémon by attacks if that damage is 60 or less.", null)
...
insert into attacks values (473, "Scale Hurricane", "Flip 4 coins. This attack does 60 damage for each heads. If at least 2 of them are heads, your opponent's Active Pokémon is now Paralyzed.", null)
...
insert into attacks values (474, "Spore", "Your opponent's Active Pokémon is now Asleep.", null)
insert into "cost" values (1766, "Colorless", 0, 474, "attack"); 
insert into attacks values (475, "Scissor Swing", "Flip 2 coins. This attack does 30 more damage for each heads.", null)
...
insert into attacks values (476, "Corner", "During your opponent's next turn, the Defending Pokémon can't retreat.", null)
...
insert into attacks values (477, "Push Down", "Switch out your opponent's Active Pokémon to the Bench. (Your opponent chooses the new Active Pokémon.)", null)
...
insert into attacks values (478, "Spore Ball", "Your opponent's Active Pokémon is now Asleep.", null)
...
insert into attacks values (479, "Champignon's Swing", "Flip a coin. If heads, this attack does 80 more damage.", null)
...
insert into attacks values (480, "Shell Smack", "Flip a coin. If heads, during your opponent's next turn, prevent all damage done to this Pokémon by attacks.", null)
...
insert into attacks values (481, "Poisonous Ploy", "Your opponent's Active Pokémon is now Confused and Poisoned. Switch this Pokémon with 1 of your Benched Pokémon.", null)
...
insert into attacks values (482, "Crunch", "Flip a coin. If heads, discard an Energy from your opponent's Active Pokémon.", null)
...
insert into attacks values (483, "Tons of Treading", "Flip 3 coins. This attack does 10 damage for each heads.", null)
...
insert into attacks values (484, "Magical Leaf", "Flip a coin. If heads, this attack does 30 more damage, and heal 30 damage from this Pokémon.", null)
...
insert into attacks values (485, "Rising Bloom", "If your opponent's Active Pokémon is a Pokémon ex, this attack does 90 more damage.", null)
...
insert into attacks values (486, "Scratch", "", null)
...
insert into attacks values (487, "Smolder-sault", "During your next turn, this Pokémon can't attack.", null)
...
insert into attacks values (488, "Back Draft", "This attack does 30 damage for each Basic Energy card in your opponent's discard pile.", null)
insert into "cost" values (1824, "Colorless", 0, 488, "attack"); 
insert into "cost" values (1825, "Colorless", 1, 488, "attack"); 
insert into attacks values (489, "Flamebody Cannon", "Discard all Energy from this Pokémon, and this attack also does 90 damage to 1 of your opponent's Benched Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
...
insert into attacks values (490, "Smoldering Scales", "", null)
...
insert into attacks values (491, "Fire Wing", "", null)
insert into "cost" values (1838, "Fire", 0, 491, "attack"); 
insert into attacks values (492, "Scorching Fire", "Discard an Energy from this Pokémon.", null)
...
insert into attacks values (493, "Scorching Cyclone", "Move an Energy from this Pokémon to 1 of your Benched Pokémon.", null)
...
insert into attacks values (494, "Frigid Fluttering", "Search your deck for up to 2 Basic Water Energy cards and attach them to this Pokémon. Then, shuffle your deck.", null)
insert into "cost" values (1850, "Colorless", 0, 494, "attack"); 
insert into attacks values (495, "Ice Blast", "", null)
...
insert into attacks values (496, "Flail", "This attack does 10 damage for each damage counter on this Pokémon.", null)
...
insert into attacks values (497, "Aqua Wash", "You may put an Energy attached to your opponent's Active Pokémon into their hand.", null)
insert into "cost" values (1857, "Water", 0, 497, "attack"); 
insert into attacks values (498, "Octo Beatdown", "Flip a coin until you get tails. This attack does 90 damage for each heads.", null)
...
insert into attacks values (499, "Aqua Slash", "During your next turn, this Pokémon can't attack.", null)
...
insert into attacks values (500, "Spit Up", "", null)
...
insert into attacks values (501, "Hydro Pump", "This attack does 50 more damage for each Water Energy attached to this Pokémon.", null)
...
insert into attacks values (502, "Icicle", "", null)
insert into "cost" values (1884, "Water", 0, 502, "attack"); 
insert into "cost" values (1885, "Colorless", 1, 502, "attack"); 
insert into attacks values (503, "Blizzard", "This attack also does 10 damage to each of your opponent's Benched Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
...
insert into attacks values (504, "Purging Strike", "You may discard your hand. If you discarded any cards in this way, this attack does 120 more damage.", null)
...
insert into attacks values (505, "Tiny Charge", "", null)
...
insert into attacks values (506, "Electric Punch", "", null)
...
insert into attacks values (507, "Electromagnetic Catapult", "Flip a coin until you get tails. This attack does 70 damage for each heads.", null)
...
insert into attacks values (508, "Voltaic Chain", "This attack does 20 more damage for each Lightning Energy attached to all of your Iono's Pokémon.", null)
...
insert into attacks values (509, "Thump-Thump Boom", "This Pokémon does 100 damage to itself. Flip a coin. If heads, your opponent's Active Pokémon is Knocked Out.", null)
...
insert into attacks values (510, "Zapping Short", "Before doing damage, discard all Pokémon Tools from your opponent's Active Pokémon. If you discarded a Pokémon Tool in this way, your opponent's Active Pokémon is now Paralyzed.", null)
...
insert into attacks values (511, "Toge Spark", "Flip a coin. If heads, during your opponent's next turn, prevent all damage from and effects of attacks done to this Pokémon.", null)
...
insert into attacks values (512, "Linked Lightning", "This attack does 20 more damage for each of your Benched Pokémon.", null)
...
insert into attacks values (513, "Full Moon Rondo", "This attack does 20 more damage for each Benched Pokémon (both yours and your opponent's).", null)
...
insert into attacks values (514, "Retaliate", "If any of your Pokémon were Knocked Out by damage from an attack during your opponent's last turn, this attack does 90 more damage.", null)
...
insert into attacks values (515, "Mimic", "Shuffle your hand into your deck. Then, draw a card for each card in your opponent's hand.", null)
...
insert into attacks values (516, "Cursed Words", "Your opponent chooses 3 cards from their hand and shuffles those cards into their deck.", null)
...
insert into attacks values (517, "Psypunch", "", null)
insert into "cost" values (1941, "Psychic", 0, 517, "attack"); 
insert into attacks values (518, "Zen Headbutt", "", null)
...
insert into attacks values (519, "Conjoined Beams", "If Beldum and Metang are on your Bench, this attack does 150 more damage.", null)
...
insert into attacks values (520, "Psychic Sphere", "", null)
insert into "cost" values (1951, "Psychic", 0, 520, "attack"); 
insert into attacks values (521, "Victory Symbol", "If you use this attack when you have exactly 1 Prize card remaining, you win this game.", null)
...
insert into attacks values (522, "Hold Still", "Heal 10 damage from this Pokémon.", null)
...
insert into attacks values (523, "Inviting Flowers", "You may search your deck for any number of Basic Lillie's Pokémon and put them onto your Bench. Then, shuffle your deck.", null)
insert into "cost" values (1958, "Colorless", 0, 523, "attack"); 
insert into attacks values (524, "Fade Out", "Put this Pokémon and all attached cards into your hand.", null)
...
insert into attacks values (525, "Mischievous Hands", "Choose 2 of your opponent's Pokémon and put 3 damage counters on each of them.", null)
insert into "cost" values (1961, "Psychic", 0, 525, "attack"); 
insert into "cost" values (1962, "Colorless", 1, 525, "attack"); 
insert into attacks values (526, "Ghostly Trip", "Your opponent's Active Pokémon is now Confused.", null)
...
insert into attacks values (527, "Anchor Smash", "", null)
...
insert into attacks values (528, "Shadowy Knot", "This attack does 50 damage for each Colorless in your opponent's Active Pokémon's Retreat Cost.", null)
...
insert into attacks values (529, "Whipped Shot", "", null)
...
insert into attacks values (530, "Impaling Tusk", "", null)
...
insert into attacks values (531, "Rumbling March", "This attack does 40 more damage for each Stage 2 Pokémon on your Bench.", null)
...
insert into attacks values (532, "Breaching Lariat", "This attack's damage isn't affected by Resistance.", null)
...
insert into attacks values (533, "Corkscrew Punch", "", null)
insert into "cost" values (2007, "Colorless", 0, 533, "attack"); 
insert into attacks values (534, "Focus Fist", "Flip a coin. If tails, this attack does nothing.", null)
...
insert into attacks values (535, "Dig It Up", "Look at the top card of your deck. You may discard that card.", null)
...
insert into attacks values (536, "Clamping Fangs", "This attack does 40 more damage for each damage counter on your opponent's Active Pokémon.", null)
...
insert into attacks values (537, "Turf Maker", "Search your deck for a Stadium card, reveal it, and put it into your hand. Then, shuffle your deck.", null)
...
insert into attacks values (538, "Rumble", "During your opponent's next turn, the Defending Pokémon can't retreat.", null)
insert into "cost" values (2022, "Fighting", 0, 538, "attack"); 
insert into "cost" values (2023, "Colorless", 1, 538, "attack"); 
insert into attacks values (539, "Break Ground", "This attack also does 20 damage to each of your Benched Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
...
insert into attacks values (540, "Snipping Pincers", "Flip 2 coins. For each heads, discard an Energy from your opponent's Active Pokémon.", null)
...
insert into attacks values (541, "Suffocating Gas", "", null)
...
insert into attacks values (542, "Pervasive Gas", "Your opponent's Active Pokémon is now Confused.", null)
insert into "cost" values (2041, "Darkness", 0, 542, "attack"); 
insert into attacks values (543, "Crazy Blast", "If this Pokémon used Pervasive Gas during your last turn, this attack does 120 more damage.", null)
...
insert into attacks values (544, "Poison Ring", "Your opponent's Active Pokémon is now Poisoned. During your opponent's next turn, that Pokémon can't retreat.", null)
...
insert into attacks values (545, "Cracking Stomp", "Discard the top 2 cards of your opponent's deck.", null)
...
insert into attacks values (546, "Thieving Swipe", "Your opponent reveals their hand, and you choose a card you find there and put it on the bottom of their deck.", null)
...
insert into attacks values (547, "Night Joker", "Choose 1 of your Benched N's Pokémon's attacks and use it as this attack.", null)
...
insert into attacks values (548, "Torment", "Choose 1 of your opponent's Active Pokémon's attacks. During your opponent's next turn, that Pokémon can't use that attack.", null)
insert into "cost" values (2065, "Darkness", 0, 548, "attack"); 
insert into attacks values (549, "Power Tackle", "During your next turn, this Pokémon can't attack.", null)
...
insert into attacks values (550, "Drop Shot", "Discard all Energy from this Pokémon, and this attack does 120 damage to 1 of your opponent's Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
...
insert into attacks values (551, "Pierce", "", null)
...
insert into attacks values (552, "Spinning Gears", "Your opponent's Active Pokémon is now Confused.", null)
...
insert into attacks values (553, "Magnetic Blast", "", null)
insert into "cost" values (2085, "Colorless", 0, 553, "attack"); 
insert into attacks values (554, "Triple Smash", "Flip 3 coins. This attack does 120 damage for each heads.", null)
...
insert into attacks values (555, "Bounding Bite", "This Pokémon also does 30 damage to itself.", null)
...
insert into attacks values (556, "Shoot Through", "This attack also does 50 damage to 1 of your opponent's Benched Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
...
insert into attacks values (557, "Mega Impact", "", null)
...
insert into attacks values (558, "Insta-Strike", "This attack also does 30 damage to 1 of your opponent's Benched Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
insert into "cost" values (2112, "Colorless", 0, 558, "attack"); 
insert into attacks values (559, "Brave Slash", "During your next turn, this Pokémon can't use Brave Slash.", null)
...
insert into attacks values (560, "Guard Press", "During your opponent's next turn, this Pokémon takes 30 less damage from attacks (after applying Weakness and Resistance).", null)
...
insert into attacks values (561, "Wide Blast", "This attack does 50 damage to each of your opponent's Benched Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
...
insert into attacks values (562, "Dragon Impact", "Discard 2 Energy from this Pokémon.", null)
...
insert into attacks values (563, "Dragon's Fury", "Attach a Basic Fire Energy card from your discard pile to 1 of your Dragon Pokémon.", null)
...
insert into attacks values (564, "Powerful Rage", "This attack does 20 damage for each damage counter on this Pokémon.", null)
insert into "cost" values (2137, "Fire", 0, 564, "attack"); 
insert into "cost" values (2138, "Lightning", 1, 564, "attack"); 
insert into attacks values (565, "Virtuous Flame", "", null)
...
insert into attacks values (566, "Dynamic Press", "This Pokémon also does 80 damage to itself.", null)
...
insert into attacks values (567, "Trading Places", "Switch this Pokémon with 1 of your Benched Pokémon.", null)
...
insert into attacks values (568, "Tenacious Tail", "This attack does 60 damage for each of your opponent's Pokémon ex in play.", null)
insert into "cost" values (2156, "Colorless", 0, 568, "attack"); 
insert into attacks values (569, "Destructive Drill", "This attack's damage isn't affected by any effects on your opponent's Active Pokémon.", null)
...
insert into attacks values (570, "Stealth Attack", "Flip a coin. If heads, during your opponent's next turn, prevent all damage from and effects of attacks done to this Pokémon.", null)
...
insert into attacks values (571, "Fruit Bearing", "Discard a card from your hand. If you do, draw 3 cards.", null)
insert into "cost" values (2167, "Colorless", 0, 571, "attack"); 
insert into attacks values (572, "Gust", "", null)
...
insert into attacks values (573, "Beckon", "Put a Supporter card from your discard pile into your hand.", null)
...
insert into attacks values (574, "Tail Smack", "", null)
...
insert into attacks values (575, "Frightening Howl", "Your opponent's Active Pokémon is now Confused.", null)
...
insert into attacks values (576, "Slumbering Smack", "Both Active Pokémon are now Asleep. During your next turn, attacks used by this Pokémon do 100 more damage to your opponent's Active Pokémon (before applying Weakness and Resistance).", null)
...
insert into attacks values (577, "Dragon Claw", "", null)
...
insert into attacks values (578, "Gluttonous Tail", "Draw 2 cards.", null)
...
insert into attacks values (579, "Intimidating Stare", "During your opponent's next turn, attacks used by the Defending Pokémon do 20 less damage (before applying Weakness and Resistance).", null)
...
insert into attacks values (580, "Razor Wing", "", null)
...
insert into attacks values (581, "Ceaseless Spitting", "Flip a coin until you get tails. This attack does 50 damage for each heads.", null)
...
insert into attacks values (582, "Fickle Spitting", "If your opponent doesn't have exactly 3 or 4 Prize cards remaining, this attack does nothing.", null)
...
insert into attacks values (583, "Aromatic Stomps", "Flip a coin. If heads, during your opponent's next turn, the Defending Pokémon can't attack.", null)
...
insert into attacks values (584, "Hyper Voice", "", null)
...
insert into attacks values (585, "Rallying Horn", "If any of your Ethan's Pokémon were Knocked Out by damage from an attack during your opponent's last turn, this attack does 100 more damage.", null)
...
insert into attacks values (586, "Whirlwind", "Switch out your opponent's Active Pokémon to the Bench. (Your opponent chooses the new Active Pokémon.)", null)
...
insert into attacks values (587, "Jet Cyclone", "Move 3 Energy from this Pokémon to 1 of your Benched Pokémon.", null)
...
insert into attacks values (588, "Hang Down", "", null)
...
insert into attacks values (589, "Damage Rush", "Flip a coin until you get tails. This attack does 50 more damage for each heads.", null)
...
insert into attacks values (590, "Spike Sting", "", null)
...
insert into attacks values (591, "Trimming Mower", "Discard a Stadium in play.", null)
insert into "cost" values (2289, "Grass", 0, 591, "attack"); 
insert into attacks values (592, "Gadget Show", "This attack does 30 damage for each Pokémon Tool attached to all of your Pokémon.", null)
...
insert into attacks values (593, "Ascension", "Search your deck for a card that evolves from this Pokémon and put it onto this Pokémon to evolve it. Then, shuffle your deck.", null)
...
insert into attacks values (594, "Superb Scissors", "This attack's damage isn't affected by any effects on your opponent's Active Pokémon.", null)
...
insert into attacks values (595, "Cut Up", "", null)
...
insert into attacks values (596, "Razor Leaf", "", null)
insert into "cost" values (2305, "Colorless", 0, 596, "attack"); 
insert into attacks values (597, "Petal Blade Dance", "Discard 2 Basic Grass Energy cards from your hand. If you can't discard 2 cards in this way, this attack does nothing.", null)
...
insert into attacks values (598, "Searching Eyes", "Look at 1 of your opponent's face-down Prize cards.", null)
...
insert into attacks values (599, "Mini Drain", "Heal 10 damage from this Pokémon.", null)
...
insert into attacks values (600, "Energy Loop", "Put an Energy attached to this Pokémon into your hand.", null)
...
insert into attacks values (601, "Hydra Breath", "Discard 6 Basic Grass Energy cards from your hand, and Knock Out your opponent's Active Pokémon. If you can't discard 6 cards in this way, this attack does nothing.", null)
...
insert into attacks values (602, "Rocket Rush", "This attack does 30 damage for each of your Team Rocket's Pokémon in play.", null)
...
insert into attacks values (603, "Oil Salvo", "Choose 1 of your opponent's Pokémon 6 times. (You can choose the same Pokémon more than once.) For each time you chose a Pokémon, do 20 damage to it. This damage isn't affected by Weakness or Resistance.", null)
insert into "cost" values (2327, "Grass", 0, 603, "attack"); 
insert into attacks values (604, "Aroma Shot", "This Pokémon recovers from all Special Conditions.", null)
...
insert into attacks values (605, "Upside-Down Draw", "Draw 3 cards from the bottom of your deck.", null)
insert into "cost" values (2334, "Colorless", 0, 605, "attack"); 
insert into attacks values (606, "Psychic", "This attack does 90 more damage for each Energy attached to your opponent's Active Pokémon.", null)
...
insert into attacks values (607, "Grass Kagura", "Search your deck for a Basic Grass Energy card and attach it to 1 of your Pokémon. Then, shuffle your deck.", null)
insert into "cost" values (2339, "Colorless", 0, 607, "attack"); 
insert into attacks values (608, "Ogre's Hammer", "During your next turn, this Pokémon can't use Ogre's Hammer.", null)
...
insert into attacks values (609, "Dig Claws", "", null)
...
insert into attacks values (610, "Punishing Fang", "If your opponent's Active Pokémon is a Darkness Pokémon, this attack does 100 more damage.", null)
...
insert into attacks values (611, "Double Headbutt", "Flip 2 coins. This attack does 10 damage for each heads.", null)
...
insert into attacks values (612, "Flame Screen", "During your opponent's next turn, this Pokémon takes 50 less damage from attacks (after applying Weakness and Resistance).", null)
...
insert into attacks values (613, "Evil Incineration", "Discard a Team Rocket's Energy from this Pokémon. If you do, discard your opponent's Active Pokémon and all attached cards.", null)
...
insert into attacks values (614, "Buddy Blast", "This attack does 60 more damage for each Ethan's Adventure card in your discard pile.", null)
insert into "cost" values (2368, "Fire", 0, 614, "attack"); 
insert into attacks values (615, "Steam Artillery", "", null)
...
insert into attacks values (616, "Lava Burst", "Discard up to 5 Fire Energy from this Pokémon. This attack does 70 damage for each card you discarded in this way.", null)
...
insert into attacks values (617, "Cruel Coal", "Your opponent's Active Pokémon is now Burned and Confused.", null)
...
insert into attacks values (618, "Shining Feathers", "Heal 50 damage from each of your Pokémon.", null)
...
insert into attacks values (619, "Double Kick", "Flip 2 coins. This attack does 40 damage for each heads.", null)
...
insert into attacks values (620, "Inferno Kick Flurry", "Discard 2 Energy from this Pokémon. This attack also does 120 damage to 1 of your opponent's Benched Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
...
insert into attacks values (621, "Fire Kagura", "Search your deck for a Basic Fire Energy card and attach it to 1 of your Pokémon. Then, shuffle your deck.", null)
...
insert into attacks values (622, "Abrupt Flash", "If this Pokémon evolved from Misty's Staryu during this turn, this attack does 80 more damage.", null)
...
insert into attacks values (623, "Splash", "", null)
...
insert into attacks values (624, "Splashing Panic", "Discard the top 7 cards of your deck, and this attack does 70 damage for each Misty's Pokémon that you discarded in this way.", null)
insert into "cost" values (2412, "Water", 0, 624, "attack"); 
insert into attacks values (625, "Waterfall", "", null)
...
insert into attacks values (626, "Swim Together", "Search your deck for up to 3 Misty's Pokémon, reveal them, and put them into your hand. Then, shuffle your deck.", null)
...
insert into attacks values (627, "Dark Frost", "If this Pokémon has any Team Rocket's Energy attached, this attack does 60 more damage.", null)
...
insert into attacks values (628, "Undulate", "Flip a coin. If heads, during your opponent's next turn, prevent all damage from and effects of attacks done to this Pokémon.", null)
...
insert into attacks values (629, "Aqua Split", "This attack also does 30 damage to 2 of your opponent's Benched Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
...
insert into attacks values (630, "Shell Press", "During your opponent's next turn, this Pokémon takes 10 less damage from attacks (after applying Weakness and Resistance).", null)
...
insert into attacks values (631, "Crescendo Wave", "This attack does 30 damage for each Water Energy attached to this Pokémon. Before doing damage, you may attach any number of Basic Water Energy cards from your hand to this Pokémon.", null)
...
insert into attacks values (632, "Frozen Wood", "If this Pokémon has 2 or more Grass Energy attached, this attack does 120 more damage.", null)
...
insert into attacks values (633, "Manual Wash", "Heal 10 damage from each of your Pokémon.", null)
...
insert into attacks values (634, "Sharp Fin", "", null)
insert into "cost" values (2455, "Water", 0, 634, "attack"); 
insert into attacks values (635, "Dive", "Flip a coin. If heads, during your opponent's next turn, prevent all damage from and effects of attacks done to this Pokémon.", null)
...
insert into attacks values (636, "Frost Smash", "", null)
...
insert into attacks values (637, "Crushing Press", "You may discard a Stadium in play. If you do, this attack does 140 more damage.", null)
...
insert into attacks values (638, "Avenging Billow", "This attack does 10 more damage for each damage counter on this Pokémon.", null)
insert into "cost" values (2474, "Water", 0, 638, "attack"); 
insert into "cost" values (2475, "Colorless", 1, 638, "attack"); 
insert into attacks values (639, "Dynamic Dive", "You may do 120 more damage. If you do, this Pokémon also does 50 damage to itself.", null)
...
insert into attacks values (640, "Water Kagura", "Search your deck for a Basic Water Energy card and attach it to 1 of your Pokémon. Then, shuffle your deck.", null)
insert into "cost" values (2484, "Colorless", 0, 640, "attack"); 
insert into attacks values (641, "Bubble Drain", "Heal 30 damage from this Pokémon.", null)
...
insert into attacks values (642, "Dual Bolt", "This attack does 50 damage to 2 of your opponent's Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
insert into "cost" values (2491, "Lightning", 0, 642, "attack"); 
insert into "cost" values (2492, "Colorless", 1, 642, "attack"); 
insert into attacks values (643, "High-Voltage Press", "If this Pokémon has at least 2 extra Energy attached (in addition to this attack's cost), this attack does 100 more damage.", null)
...
insert into attacks values (644, "Jamming Wing", "You may move an Energy from your opponent's Active Pokémon to 1 of their Benched Pokémon.", null)
insert into "cost" values (2500, "Colorless", 0, 644, "attack"); 
insert into "cost" values (2501, "Colorless", 1, 644, "attack"); 
insert into attacks values (645, "Wicked Thunder", "If this Pokémon has any Team Rocket's Energy attached, this attack does 60 more damage.", null)
...
insert into attacks values (646, "Zapping Draw", "Draw a card.", null)
...
insert into attacks values (647, "Procurement", "Search your deck for an Item card, reveal it, and put it into your hand. Then, shuffle your deck.", null)
...
insert into attacks values (648, "Thunder Shock", "Flip a coin. If heads, your opponent's Active Pokémon is now Paralyzed.", null)
...
insert into attacks values (649, "Head Bolt", "", null)
...
insert into attacks values (650, "Zap Kick", "", null)
insert into "cost" values (2518, "Colorless", 0, 650, "attack"); 
insert into attacks values (651, "Flash Impact", "This attack also does 40 damage to 1 of your Benched Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
...
insert into attacks values (652, "Astonish", "Choose a random card from your opponent's hand. Your opponent reveals that card and shuffles it into their deck.", null)
...
insert into attacks values (653, "Thunder Raid", "Discard all Energy from this Pokémon, and this attack does 210 damage to 1 of your opponent's Benched Pokémon ex. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
...
insert into attacks values (654, "Hypnotic Ray", "Your opponent's Active Pokémon is now Asleep.", null)
...
insert into attacks values (655, "Bench Manipulation", "Your opponent flips a coin for each of their Benched Pokémon. This attack does 80 damage to your opponent's Active Pokémon for each tails. This attack's damage isn't affected by Weakness or Resistance.", null)
...
insert into attacks values (656, "Erasure Ball", "You may discard up to 2 Energy from your Benched Pokémon. This attack does 60 more damage for each card you discarded in this way.", null)
...
insert into attacks values (657, "Rocket Mirror", "Move all damage counters from 1 of your Benched Team Rocket's Pokémon to your opponent's Active Pokémon.", null)
...
insert into attacks values (658, "Summoning Sign", "Search your deck for up to 2 Basic Steven's Pokémon and put them onto your Bench. Then, shuffle your deck.", null)
...
insert into attacks values (659, "Eerie Light", "Your opponent's Active Pokémon is now Confused.", null)
insert into "cost" values (2548, "Psychic", 0, 659, "attack"); 
insert into attacks values (660, "Clay Blast", "Discard all Energy from this Pokémon.", null)
...
insert into attacks values (661, "Chiming Commotion", "Discard a random card from your opponent's hand.", null)
...
insert into attacks values (662, "Gemstone Mimicry", "Choose 1 of your opponent's Active Tera Pokémon's attacks and use it as this attack.", null)
...
insert into attacks values (663, "Disruptive Radar", "Look at the top 5 cards of your opponent's deck and put them back in any order.", null)
...
insert into attacks values (664, "Wild Kick", "Flip a coin. If tails, this attack does nothing.", null)
...
insert into attacks values (665, "Impact Blow", "During your next turn, this Pokémon can't use Impact Blow.", null)
...
insert into attacks values (666, "Impound", "During your opponent's next turn, the Defending Pokémon can't retreat.", null)
insert into "cost" values (2571, "Fighting", 0, 666, "attack"); 
insert into attacks values (667, "Try to Imitate", "Flip a coin. If heads, choose 1 of your opponent's Active Pokémon's attacks and use it as this attack.", null)
...
insert into attacks values (668, "Mountain Munch", "Discard the top card of your opponent's deck.", null)
...
insert into attacks values (669, "Explosive Ascension", "Search your deck for a card that evolves from this Pokémon and put it onto this Pokémon to evolve it. Then, shuffle your deck.", null)
...
insert into attacks values (670, "Demolition Tackle", "Discard an Energy from your opponent's Active Pokémon.", null)
...
insert into attacks values (671, "Mountain Drop", "If a Stadium is in play, this attack does 70 more damage.", null)
...
insert into attacks values (672, "Steady Punch", "Flip a coin. If heads, this attack does 20 more damage.", null)
...
insert into attacks values (673, "Harmonious Spirit Palm", "If this Pokémon and your opponent's Active Pokémon have the same amount of Energy attached, this attack does 120 more damage.", null)
...
insert into attacks values (674, "Regi Charge", "Attach up to 2 Basic Fighting Energy cards from your discard pile to this Pokémon.", null)
insert into "cost" values (2600, "Colorless", 0, 674, "attack"); 
insert into attacks values (675, "Giant Rock", "If your opponent's Active Pokémon is a Stage 2 Pokémon, this attack does 140 more damage.", null)
...
insert into attacks values (676, "Dragonslice", "", null)
...
insert into attacks values (677, "Corkscrew Dive", "You may draw cards until you have 6 cards in your hand.", null)
insert into "cost" values (2611, "Fighting", 0, 677, "attack"); 
insert into attacks values (678, "Draconic Buster", "Discard all Energy from this Pokémon.", null)
...
insert into attacks values (679, "Super Sandstorm", "This attack also does 40 damage to each Benched Pokémon that has any damage counters on it (both yours and your opponent's). (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
...
insert into attacks values (680, "Running Charge", "Flip a coin until you get tails. This attack does 40 damage for each heads.", null)
...
insert into attacks values (681, "Rock Kagura", "Search your deck for a Basic Fighting Energy card and attach it to 1 of your Pokémon. Then, shuffle your deck.", null)
insert into "cost" values (2635, "Colorless", 0, 681, "attack"); 
insert into attacks values (682, "Mountain Ramming", "Discard the top card of your opponent's deck.", null)
...
insert into attacks values (683, "Drag Down", "Flip a coin. If heads, your opponent's Active Pokémon is now Paralyzed.", null)
...
insert into attacks values (684, "Spinning Tail", "This attack does 30 damage to each of your opponent's Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
...
insert into attacks values (685, "Dark Awakening", "Choose up to 2 of your Darkness Pokémon. For each of those Pokémon, search your deck for a card that evolves from that Pokémon and put it onto that Pokémon to evolve it. Then, shuffle your deck.", null)
...
insert into attacks values (686, "Love Impact", "If a Pokémon that has 'Nidoking' in its name is on your Bench, this attack does 120 more damage.", null)
insert into "cost" values (2651, "Darkness", 0, 686, "attack"); 
insert into attacks values (687, "Mega Kick", "", null)
...
insert into attacks values (688, "Horn Rend", "If your opponent's Active Pokémon already has any damage counters on it, this attack does 60 more damage.", null)
...
insert into attacks values (689, "Tainted Horn", "Your opponent's Active Pokémon is now Poisoned. During Pokémon Checkup, put 8 damage counters on that Pokémon instead of 1.", null)
...
insert into attacks values (690, "Kingly Impact", "", null)
...
insert into attacks values (691, "Poison Spray", "Your opponent's Active Pokémon is now Poisoned.", null)
...
insert into attacks values (692, "Confuse Ray", "Your opponent's Active Pokémon is now Confused.", null)
...
insert into attacks values (693, "Assassin's Return", "You may put this Pokémon into your hand. (Discard all cards attached to this Pokémon.)", null)
...
insert into attacks values (694, "Corrosive Sludge", "At the end of your opponent's next turn, discard the Defending Pokémon and all attached cards.", null)
...
insert into attacks values (695, "Gooped Up", "Your opponent's Active Pokémon is now Confused. During your opponent's next turn, that Pokémon can't retreat.", null)
insert into "cost" values (2685, "Darkness", 0, 695, "attack"); 
insert into "cost" values (2686, "Colorless", 1, 695, "attack"); 
insert into attacks values (696, "Hazardous Venom", "This attack does 100 damage for each Special Condition affecting your opponent's Active Pokémon.", null)
...
insert into attacks values (697, "Leaking Gas", "", null)
...
insert into attacks values (698, "Explode Together Now", "This attack does 40 damage for each Pokémon in play that has 'Koffing' or 'Weezing' in its name (both yours and your opponent's).", null)
...
insert into attacks values (699, "Deceit", "Search your deck for a Supporter card, reveal it, and put it into your hand. Then, shuffle your deck.", null)
...
insert into attacks values (700, "Strike the Sleeper", "This attack does 20 damage to 1 of your opponent's Benched Pokémon for each damage counter on that Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
...
insert into attacks values (701, "Raging Curse", "This attack does 10 damage for each damage counter on all of your Benched Cynthia's Pokémon. This attack's damage isn't affected by Weakness.", null)
...
insert into attacks values (702, "Pointy Nails", "If your opponent's Active Pokémon is a Pokémon ex, this attack does 40 more damage.", null)
...
insert into attacks values (703, "Pointy Claws", "If your opponent's Active Pokémon is a Pokémon ex, this attack does 70 more damage.", null)
...
insert into attacks values (704, "Filch", "Draw a card.", null)
...
insert into attacks values (705, "Shadow Bullet", "This attack also does 30 damage to 1 of your opponent's Benched Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
...
insert into attacks values (706, "Spiky Wheel", "This attack does 40 more damage for each Darkness Energy attached to this Pokémon.", null)
...
insert into attacks values (707, "Vigorous Tackle", "If this Pokémon has no damage counters on it, this attack does 120 more damage.", null)
insert into "cost" values (2728, "Colorless", 0, 707, "attack"); 
insert into attacks values (708, "Boss Headbutt", "During your next turn, this Pokémon can't use Boss Headbutt.", null)
...
insert into attacks values (709, "Iron Shake-Up", "You may move any amount of Metal Energy from your Pokémon to your other Pokémon in any way you like.", null)
insert into "cost" values (2735, "Colorless", 0, 709, "attack"); 
insert into attacks values (710, "Hurricane of Needles", "Flip 4 coins. This attack does 80 damage for each heads.", null)
...
insert into attacks values (711, "Roost", "Heal 50 damage from this Pokémon. During your next turn, this Pokémon can't retreat.", null)
insert into "cost" values (2742, "Colorless", 0, 711, "attack"); 
insert into attacks values (712, "Metal Claw", "", null)
...
insert into attacks values (713, "Sonic Double", "This attack does 50 damage to 2 of your opponent's Pokémon. (Don't apply Weakness and Resistance for Benched Pokémon.)", null)
...
insert into attacks values (714, "Metal Slash", "During your next turn, this Pokémon can't attack.", null)
...
insert into attacks values (715, "Metal Stomp", "", null)
...
insert into attacks values (716, "Strong Bash", "During your opponent's next turn, if this Pokémon is damaged by an attack (even if this Pokémon is Knocked Out), put damage counters on the Attacking Pokémon equal to the damage done to this Pokémon.", null)
...
insert into attacks values (717, "Dangerous Incisors", "Your opponent's Active Pokémon is now Poisoned.", null)
...
insert into attacks values (718, "Reckless Abandon", "Flip 2 coins. If both of them are tails, this Pokémon also does 90 damage to itself.", null)
...
insert into attacks values (719, "Paw-cket Pilfer", "Choose a random card from your opponent's hand. Your opponent reveals that card and shuffles it into their deck.", null)
insert into "cost" values (2770, "Colorless", 0, 719, "attack"); 
insert into attacks values (720, "Fury Swipes", "Flip 3 coins. This attack does 20 damage for each heads.", null)
...
insert into attacks values (721, "Haughty Order", "Reveal the top 10 cards of your opponent's deck. You may choose an attack from a Pokémon you find there and use it as this attack. Shuffle the revealed cards into your opponent's deck.", null)
insert into "cost" values (2774, "Colorless", 0, 721, "attack"); 
insert into "cost" values (2775, "Colorless", 1, 721, "attack"); 
insert into attacks values (722, "Cruel Slash", "Your opponent's Active Pokémon is now Confused.", null)
...
insert into attacks values (723, "Dizzy Punch", "Flip 2 coins. This attack does 90 damage for each heads.", null)
...
insert into attacks values (724, "Clean Hit", "If your opponent's Active Pokémon is an Evolution Pokémon, this attack does 50 more damage.", null)
...
insert into attacks values (725, "Hacking", "Discard a card from your hand. If you do, your opponent discards a card from their hand.", null)
...
insert into attacks values (726, "R Command", "This attack does 20 damage for each Supporter card that has 'Team Rocket' in its name in your discard pile.", null)
...
insert into attacks values (727, "Wing Attack", "", null)
...
insert into attacks values (728, "Gnaw Through", "Before doing damage, discard all Pokémon Tools from your opponent's Active Pokémon.", null)
